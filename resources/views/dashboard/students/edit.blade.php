    ...
    <div class="card mx-2 mx-md-2 shadow-5-strong bg-body-tertiary"
        ...
        <div class="card-body py-5 px-md-5">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-5 text-center">Edit</h2>
                    ...
                    <form action="{{ route('students.update',$student->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <x-form.input type="text" name="name" class="form-control" placeholder="First Name" value="{{ $student->name}} "/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <x-form.input type="text" name="last_name" class="form-control"
                        ...
                        <div data-mdb-input-init class="form-outline mb-3">
                            <x-form.input type="email" name="email" class="form-control" placeholder="Email address" value="{{ $student->email}} "/>

                        </div>


                        <div data-mdb-input-init class="form-outline mb-3">
                            <x-form.input type="number" name="number" class="form-control" placeholder="Number Phone" value="{{ $student->number}}"/>

                        </div>
                        {{--  date  --}}
                        <div data-mdb-input-init class="form-outline mb-3">
                            <x-form.input type="date" name="birthday" class="form-control" placeholder="Birth Date" value="{{ $student->date}}"/>
